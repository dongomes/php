...
<body>
  <?php
    ...
    function mostrar_elementos3 ($n, $key){
      /*
        Queremos imprimir un mensaje con la posición del elemento del array interno y el valor de esa iteración y tambien muestra la iteracion
      */
      global $i, $j;
      echo "<br>";
      echo "En la posicion \$array [$j][$key] el valor de la variable es $n y la iteracion es $i";
      $i++;
      if(key==0){
        $j++;
      }
